...
## Built With
- **Frontend**: Vue 3, Pinia, Fabric.js, Tailwind CSS
- **Backend**: FastAPI, WebSockets
- **Features**: Real-time sync, object manipulation, text editing, export/import, grid/snap, zoom/pan, history, stickers, auto-save